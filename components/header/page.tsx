...
const Header = () => {
  ...
  const links = [
    ...
    { id: 3, href: "/menu", title: "Menu" },
    { id: 4, href: "/pages", title: "Pages" },
    ...
    <div>
      <div className={styles.header}>
        ...
        <div className={styles.logo}>
          ...
          <span className={styles.logoName}>Chef Hadi</span>
        </div>
        {/* Nav */}
          ...
          <ul className={styles.pages}>
            {links.map((link) => (
              <li key={link.id}>
                <Link style={{ textDecoration: "none" }} href={link.href}>
                  <p
                    className={
                      path === link.href ? styles.activeLink : styles.link
                    }
                  >
                    {link.title}
                  </p>
            ...
            <Link href={"/bookaTable"}>
              <button className={styles.bookButton}>
                <span className={styles.script}>Book A Table</span>
              </button>
            </Link>
          </ul>
        </div>
